...
export const getFilteredFavoriteCards = ({cards}, isFavorite) => cards.filter(card => card.isFavorite == true);
...
export const cardFavorite = payload => ({type: 'TOGGLE_CARD_FAVORITE', payload});
